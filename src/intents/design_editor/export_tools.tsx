...
const BOOKMARKLET =
  "javascript:(function(){if(window._cvt){clearInterval(window._cvt);}window._cvt=setInterval(function(){fetch('http://localhost:3001/pending',{cache:'no-store'}).then(function(r){return r.json()}).then(function(d){if(d.id){var a=document.createElement('a');a.href='http://localhost:3001/download/'+d.id;a.download=d.fileName||'export.zip';document.body.appendChild(a);a.click();a.remove();}}).catch(function(){});},900);})();";
